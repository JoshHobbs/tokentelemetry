...
import { Copy, Check, GitBranch, ArrowRight, Activity } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="max-w-[1320px] mx-auto px-5 sm:px-8 pt-16 sm:pt-24 pb-10 sm:pb-16">
        ...
        {/* Headline */}
        <h1 className="text-center text-[40px] sm:text-[56px] md:text-[68px] leading-[1.04] tracking-[-0.025em] font-semibold text-[var(--tt-fg)] mb-5 max-w-4xl mx-auto">
        ...
        {/* Subhead */}
        <p className="text-center text-[15px] sm:text-[17px] text-[var(--tt-fg-muted)] max-w-2xl mx-auto leading-relaxed mb-3">
        ...
        <p className="text-center text-[13px] sm:text-[14px] text-[var(--tt-fg-dim)] font-mono italic mb-9 transition-opacity">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-2 text-[11px] text-[var(--tt-fg-dim)] font-mono text-center">
        ...
        <div className="mt-14 sm:mt-20 relative">
          <div aria-hidden className="absolute -inset-x-12 -top-10 -bottom-10 pointer-events-none bg-gradient-to-tr from-[color:var(--tt-brand-glow)] via-transparent to-transparent blur-3xl" />
          <div className="relative mx-auto max-w-[1280px] rounded-[var(--tt-radius-xl)] overflow-hidden border border-[var(--tt-border-strong)] bg-[var(--tt-panel)] shadow-[0_30px_120px_-30px_rgba(96,165,250,0.35)]">
            <BrowserChromeBar label="tokentelemetry · dashboard" />
            <img
              src="/screenshots/dashboard.png"
              alt="TokenTelemetry dashboard"
...
function BrowserChromeBar({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-1.5 px-4 h-9 bg-[var(--tt-raised)] border-b border-[var(--tt-border)]">
      ...
      <span className="ml-3 inline-flex items-center gap-1.5 text-[11px] font-mono text-[var(--tt-fg-dim)] truncate">
        <Activity size={11} className="text-[var(--tt-brand)]" /> {label}
      </span>
    </div>
  );
}
